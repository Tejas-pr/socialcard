    ...
    >
      ...
      >
        <div className="flex items-center justify-between px-8 bg-slate-300">
            ...
            <div>
                ...
                <div
                    ...
                    onClick={() => window.open("mailto:tejas.teju02@gmail.com", "_blank", "noopener,noreferrer")}
                >
                    <img
                ...
                <div
                    className="hover:cursor-pointer"
                    onClick={() => window.open("tel:9538632743", "_blank", "noopener,noreferrer")}
                >
                    <img
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 px-6 py-2 gap-2">
            {/* card 1  */}
            <div className="bg-slate-200 rounded-lg flex flex-row md:flex-col items-center justify-center hover:cursor-pointer hover:shadow-lg shadow-slate-600"
            onClick={() => window.open("https://github.com/Tejas-pr", "_blank", "noopener,noreferrer")}
            >
                <div className="rounded-full bg-slate-200 p-1 md:p-3">
                    <img src="https://avatars.githubusercontent.com/u/129583682?v=4" alt="" className="rounded-full w-12 md:w-28 ml-2 md:ml-0" />
                </div>
                <div className="px-2 flex flex-col items-center justify-center md:space-y-2 mb-2">
                    ...
                    <div className="flex items-center justify-between gap-1 md:gap-4 space-x-1 bg-white/60 rounded-md p-2 md:p-4">
                        <div className="space-y-1">
                            <p className="font-light text-xs md:text-base">following :<span>100</span></p>
                            <p className="font-light text-xs md:text-base">followers :<span>100</span></p>
                        </div>
                        <div className="space-y-1">
                            <p className="font-light text-xs md:text-base">repos :<span>100</span></p>
                            <p className="font-light text-xs md:text-base">gists :<span>100</span></p>
                        </div>
                    </div>
                </div>
            </div>
